...
void M_Options_Draw(void)
{
	...
	M_Print(16, 64 - 8, "            Brightness");
	r = (1.0 - v_gamma.value) / 0.5;
	M_DrawSlider(220, 64 - 8, r);

	M_Print(16, 72 - 8, "           Mouse Speed");
	r = (sensitivity.value - 1) / 10;
	M_DrawSlider(220, 72 - 8, r);

	M_Print(16, 80 - 8, "          Music Volume");
	r = bgmvolume.value;
	M_DrawSlider(220, 80 - 8, r);

	M_Print(16, 88 - 8, "          Sound Volume");
	r = volume.value;
	M_DrawSlider(220, 88 - 8, r);

	M_Print(16, 80 + 16 - 8, "            Always Run");
	M_DrawCheckbox(220, 80 + 16 - 8, cl_forwardspeed.value > 200);

	M_Print(16, 96 + 8 - 8, "          Invert Mouse");
	M_DrawCheckbox(220, 96 + 8 - 8, m_pitch.value < 0);

	M_Print(16, 104 + 8 - 8, "            Lookspring");
	M_DrawCheckbox(220, 104 + 8 - 8, lookspring.value);

	M_Print(16, 112 + 8 - 8, "            Lookstrafe");
	M_DrawCheckbox(220, 112 + 8 - 8, lookstrafe.value);
...
void M_Quit_Draw(void)
{
	...
	*/
	M_PrintWhite(16, 12, "  Baserisk ver 1.0a\n\n");
	M_PrintWhite(16, 28, "	The Team\n");
	M_Print(16, 36, " Konotsu, Shadesmaster\n");
	M_Print(16, 44, " Xieken, Ryokuo, FADE\n");
...
level_t		levels[] =
{
	...
	{"map00", "Intro"},				// 1
	{"map01", "To the chamber"},
	{"testroomabc", "TestRoomABC"},
